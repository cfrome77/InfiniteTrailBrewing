    ...
    <main className="min-h-screen bg-forest text-tan">
      ...
      <section className="relative pt-32 pb-12 md:pt-40 md:pb-16 text-center overflow-hidden border-b border-tan/10">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl mb-4">Brew Lab</h1>
          <div className="w-24 h-1 bg-tan mx-auto mb-6" />
          <p className="text-lg text-tan/80 max-w-2xl mx-auto italic font-light">
            Brewing logs, fermentation tracking, water chemistry, and recipe data for active and archived Infinite Trail Brewing batches.
          </p>
        </div>
      </section>

      <Suspense fallback={<div className="text-center py-32 text-tan/50 font-mono">Loading brew logs...</div>}>
