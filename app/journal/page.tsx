...
import { Calendar, Beaker, BookOpen, Clock, Tag } from "lucide-react";
                        ...
                        <div className="mb-6 p-4 rounded-xl bg-tan/10 border border-tan/30 inline-flex items-center gap-4 text-left max-w-full">
                          ...
                          <div className="min-w-0">
                            ...
                            {relatedBeer.batchNumber && (
                              <span className="inline-flex items-center gap-1 font-mono text-[10px] text-sky bg-sky/10 border border-sky/20 px-2 py-0.5 rounded-full mt-1">
